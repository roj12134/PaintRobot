...
% Last Modified by GUIDE v2.5 17-Nov-2015 13:20:03
...
% --- Otherwise, executes on mouse press in 5 pixel border or over takePhotoButton.
function takePhotoButton_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to takePhotoButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
