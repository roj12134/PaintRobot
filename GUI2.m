...
warndlg('Trayectorias Calculadas . . .');

scrsz = get(groot,'ScreenSize');
brazoPlot = figure('Name','Paint Robot','NumberTitle','off','Position',[1 1 scrsz(3) scrsz(4)],'MenuBar', 'none');
Brazo.plot(trayectorias, 'workspace', [-0.5 0.5 -.2 .4 0 .8]);
